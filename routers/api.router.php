...
$router->get('/locals', 'API\APIController@getProvince');
$router->get('/locals/{provinceid}/{districtid}', 'API\APIController@getward');
$router->get('/locals/{provinceid}', 'API\APIController@getDistrict');
